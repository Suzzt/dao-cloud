...
public class MessageType {
    ...
    static {
        ...
        MESSAGE_TYPE_MAP.put(SYNC_CLUSTER_SERVER_REQUEST_MESSAGE, ClusterSyncDataModel.class);
        MESSAGE_TYPE_MAP.put(SYNC_CLUSTER_SERVER_RESPONSE_MESSAGE, NumberingModel.class);
    }
