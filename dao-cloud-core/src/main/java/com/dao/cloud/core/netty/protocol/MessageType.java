...
public class MessageType {
    ...
    public static final byte PULL_REMOTE_CENTER_PROPERTY_REQUEST_MESSAGE = 26;
    public static final byte PULL_REMOTE_CENTER_PROPERTY_RESPONSE_MESSAGE = 27;
    ...
    static {
        ...
        MESSAGE_TYPE_MAP.put(PULL_REMOTE_CENTER_PROPERTY_REQUEST_MESSAGE, ProxyConfigModel.class);
        MESSAGE_TYPE_MAP.put(PULL_REMOTE_CENTER_PROPERTY_RESPONSE_MESSAGE, RemoteCenterPropertyModel.class);
    }
