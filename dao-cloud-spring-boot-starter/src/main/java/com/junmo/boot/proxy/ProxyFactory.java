...
import com.junmo.core.handler.RpcResponseMessageHandler;
import com.junmo.core.model.DaoMessage;
import com.junmo.core.model.RpcRequestModel;
import com.junmo.core.netty.ClientChannelFactory;
...
public class ProxyFactory {
    ...
    static class ProxyHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            // push message
            ClientChannelFactory.getChannel("127.0.01", 6661).writeAndFlush(message);

            // 异步！ promise 对象来处理异步接收的结果线程
            DefaultPromise<Object> promise = new DefaultPromise<>(ClientChannelFactory.getChannel("127.0.01", 6661).eventLoop());
