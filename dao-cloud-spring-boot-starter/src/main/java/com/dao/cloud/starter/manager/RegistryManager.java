...
public class RegistryManager {
    ...
    public static Set<ServerNodeModel> pull(ProxyProviderModel proxyProviderModel) throws Exception {
        DaoMessage daoMessage = new DaoMessage(Protocol.DEFAULT_VERSION, MessageType.PULL_REGISTRY_SERVER_REQUEST_MESSAGE, Protocol.DEFAULT_SERIALIZE, proxyProviderModel);
    ...
    private static void send(RegisterProviderModel registerProviderModel) throws DaoException {
        ...
        DaoMessage daoMessage = new DaoMessage(Protocol.DEFAULT_VERSION, MessageType.REGISTRY_REQUEST_MESSAGE, Protocol.DEFAULT_SERIALIZE, registerProviderModel);
